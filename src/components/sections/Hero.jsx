...
export default function Hero() {
  return (
    <section id="inicio" className="w-full min-h-screen flex items-center justify-center py-20 sm:py-32 px-6 md:px-12 relative">
      ...
      {/* Glow  verde */}
      <div 
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-lime-500/10 rounded-full blur-3xl pointer-events-none"
      ></div>
  ...
  <p className="text-xl sm:text-2xl text-gray-400 leading-relaxed max-w-3xl px-4 sm:px-8 md:px-12 text-center">
    ...
    resultados reales.
        ...
        {/* Stats minimalistas */}
        <div className="w-full grid grid-cols-1 sm:grid-cols-3 gap-8 mt-24 max-w-5xl mx-auto pt-16 border-t border-white/[0.08]">
          {[
